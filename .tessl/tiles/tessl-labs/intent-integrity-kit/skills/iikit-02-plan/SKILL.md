...
```bash
bash .tessl/tiles/tessl-labs/intent-integrity-kit/skills/iikit-02-plan/scripts/bash/generate-dashboard-safe.sh
```
Windows: `pwsh .tessl/tiles/tessl-labs/intent-integrity-kit/skills/iikit-02-plan/scripts/powershell/generate-dashboard-safe.ps1`
