...
|-------------|-----------|----------|-----------|-----------|
| FR-001 | Yes | T005, T008 | Yes | Requirements Traceability, Implementation Strategy §Phase 3 |
| FR-002 | Yes | T010, T012 | Yes | Requirements Traceability, Implementation Strategy §Phase 4 |
| FR-003 | Yes | T010, T011, T012 | Yes | Requirements Traceability, Implementation Strategy §Phase 4 |
| FR-004 | Yes | T004, T006 | Yes | Requirements Traceability, Implementation Strategy §Phase 2 |
| FR-005 | Yes | T010, T012 | Yes | Requirements Traceability, Implementation Strategy §Phase 4 |
| FR-006 | Yes | T016, T017 | Yes | Requirements Traceability, Implementation Strategy §Phase 3 |
| FR-007 | Yes | T018, T019 | Yes | Requirements Traceability, Implementation Strategy §Phase 4 |
| FR-008 | Yes | T010, T012 | Yes | Requirements Traceability, Implementation Strategy §Phase 3 |
| FR-009 | Yes | T005, T008 | Yes | Requirements Traceability, Implementation Strategy §Phase 3 |
| FR-010 | Yes | T011, T014 | Yes | Requirements Traceability, Key Technical Decisions D6, Implementation Strategy §Phase 4 |
| FR-011 | Yes | T010, T008 | Yes | Requirements Traceability, Implementation Strategy §Phase 3 |
| FR-012 | Yes | T010, T013 | Yes | Requirements Traceability, Implementation Strategy §Phase 4 |
| FR-013 | Yes | T018, T019 | Yes | Requirements Traceability, Implementation Strategy §Phase 4 |
| NFR-001 | Yes | T016, T017 | Yes | Requirements Traceability, Implementation Strategy §Phase 3 |
| SC-001 | Yes | T010, T012 | Yes | Requirements Traceability, Implementation Strategy §Phase 5 |
| SC-002 | Yes | T011, T012 | Yes | Requirements Traceability, Implementation Strategy §Phase 5 |
| SC-003 | Yes | T016, T017 | Yes | Requirements Traceability, Technical Context: Performance Goals |
| SC-004 | Yes | T011, T012 | Yes | Requirements Traceability, Constitution Check table |
